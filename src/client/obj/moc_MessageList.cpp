...
QT_MOC_LITERAL(1, 12, 12), // "signalUpdate"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "enterChat"
QT_MOC_LITERAL(4, 36, 5), // "index"
QT_MOC_LITERAL(5, 42, 6) // "update"

    },
    "MessageList\0signalUpdate\0\0enterChat\0"
    "index\0update"
};
...
void MessageList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->enterChat((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (MessageList::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageList::signalUpdate)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MessageList::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_MessageList.data,
      qt_meta_data_MessageList,  qt_static_metacall, nullptr, nullptr}
};
