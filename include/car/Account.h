...
RCF_METHOD_R3(bool, logout, const std::string &, const std::string &, int);
...
RCF_BEGIN(AccountNofity, "AccountNofity")
	...
	RCF_METHOD_V2(void, onUserLogout, const std::string &, int);

RCF_END(AccountNofity)
